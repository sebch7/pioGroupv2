<?php
	...
	{
		header('location:../docente.php?msg=DP');	
	}
	else
	{
		...
		$consulta2 = $db->insertar('Usuario','contrasena,idEmpleado,idPerfil','"'.md5($contrasena).'","'.$_POST['identificacion'].'","4"');
		...
		header('location:../docente.php?msg=CR');
	}
