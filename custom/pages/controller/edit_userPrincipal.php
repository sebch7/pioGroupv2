<?php
	...
	$historial = $db->insertar('Historial','fecha,modulo,tabla,accion,textoAnterior,textoNuevo,idEmpleado','"'.date('Y-m-d h:i:s').'","Usuarios principales","Usuario principal","Editar Usuario principal","'.$anterior.'","'.$nuevo.'",'.$_SESSION['usuario']);
